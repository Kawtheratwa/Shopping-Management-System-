...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1393: Date.now,
      _1395: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1396: s => {
      ...
      _1398: () => typeof dartUseDateNowForTicks !== "undefined",
      _1399: () => 1000 * performance.now(),
      _1400: () => Date.now(),
      _1401: () => {
      ...
      _1403: () => new WeakMap(),
      _1404: (map, o) => map.get(o),
      _1405: (map, o, v) => map.set(o, v),
      _1406: x0 => new WeakRef(x0),
      _1407: x0 => x0.deref(),
      _1414: () => globalThis.WeakRef,
      _1418: s => JSON.stringify(s),
      _1419: s => printToConsole(s),
      _1420: (o, p, r) => o.replaceAll(p, () => r),
      _1421: (o, p, r) => o.replace(p, () => r),
      _1422: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1423: s => s.toUpperCase(),
      _1424: s => s.trim(),
      _1425: s => s.trimLeft(),
      _1426: s => s.trimRight(),
      _1427: (string, times) => string.repeat(times),
      _1428: Function.prototype.call.bind(String.prototype.indexOf),
      _1429: (s, p, i) => s.lastIndexOf(p, i),
      _1430: (string, token) => string.split(token),
      _1431: Object.is,
      _1432: o => o instanceof Array,
      _1433: (a, i) => a.push(i),
      _1434: (a, i) => a.splice(i, 1)[0],
      _1436: (a, l) => a.length = l,
      _1437: a => a.pop(),
      _1438: (a, i) => a.splice(i, 1),
      _1439: (a, s) => a.join(s),
      _1440: (a, s, e) => a.slice(s, e),
      _1441: (a, s, e) => a.splice(s, e),
      _1442: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1443: a => a.length,
      _1444: (a, l) => a.length = l,
      _1445: (a, i) => a[i],
      _1446: (a, i, v) => a[i] = v,
      _1448: o => o instanceof ArrayBuffer,
      _1449: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1451: o => o instanceof Uint8Array,
      _1452: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1453: o => o instanceof Int8Array,
      _1454: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1455: o => o instanceof Uint8ClampedArray,
      _1456: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1457: o => o instanceof Uint16Array,
      _1458: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1459: o => o instanceof Int16Array,
      _1460: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1461: o => o instanceof Uint32Array,
      _1462: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1463: o => o instanceof Int32Array,
      _1464: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1466: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1467: o => o instanceof Float32Array,
      _1468: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1469: o => o instanceof Float64Array,
      _1470: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1471: (t, s) => t.set(s),
      _1473: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1474: o => o.byteLength,
      _1475: o => o.buffer,
      _1476: o => o.byteOffset,
      _1477: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1478: (b, o) => new DataView(b, o),
      _1479: (b, o, l) => new DataView(b, o, l),
      _1480: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1481: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1482: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1483: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1484: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1485: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1486: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1487: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1488: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1489: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1490: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1491: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1494: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1495: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1496: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1497: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1498: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1499: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1512: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1513: (handle) => clearTimeout(handle),
      _1514: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1515: (handle) => clearInterval(handle),
      _1516: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1517: () => Date.now(),
      _1522: o => Object.keys(o),
      _1523: (x0,x1) => new WebSocket(x0,x1),
      _1524: (x0,x1) => x0.send(x1),
      _1525: (x0,x1,x2) => x0.close(x1,x2),
      _1527: x0 => x0.close(),
      _1528: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1529: (x0,x1) => globalThis.fetch(x0,x1),
      _1530: (x0,x1) => x0.get(x1),
      _1531: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1531(f,arguments.length,x0,x1,x2) }),
      _1532: (x0,x1) => x0.forEach(x1),
      _1533: x0 => x0.abort(),
      _1534: () => new AbortController(),
      _1535: x0 => x0.getReader(),
      _1536: x0 => x0.read(),
      _1537: x0 => x0.cancel(),
      _1538: x0 => ({withCredentials: x0}),
      _1539: (x0,x1) => new EventSource(x0,x1),
      ...
      _1542: x0 => x0.close(),
      _1543: (x0,x1,x2) => ({method: x0,body: x1,credentials: x2}),
      _1544: (x0,x1,x2) => x0.fetch(x1,x2),
      _1547: () => new XMLHttpRequest(),
      _1548: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1549: x0 => x0.send(),
      _1551: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1563: x0 => ({body: x0}),
      _1564: (x0,x1) => new Notification(x0,x1),
      _1565: () => globalThis.Notification.requestPermission(),
      _1566: x0 => x0.close(),
      _1567: x0 => x0.reload(),
      _1568: (x0,x1) => x0.groupCollapsed(x1),
      _1569: (x0,x1) => x0.log(x1),
      _1570: x0 => x0.groupEnd(),
      _1571: (x0,x1) => x0.warn(x1),
      _1572: (x0,x1) => x0.error(x1),
      _1573: x0 => x0.measureUserAgentSpecificMemory(),
      _1574: x0 => x0.bytes,
      ...
      _1586: x0 => x0.blur(),
      _1587: (x0,x1) => x0.replace(x1),
      _1588: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      _1598: (s, m) => {
        try {
      ...
      _1670: (d, precision) => d.toPrecision(precision),
      _1671: () => globalThis.document,
      _1672: () => globalThis.window,
      _1677: (x0,x1) => { x0.height = x1 },
      _1679: (x0,x1) => { x0.width = x1 },
      _1682: x0 => x0.head,
      _1683: x0 => x0.classList,
      _1687: (x0,x1) => { x0.innerText = x1 },
      _1688: x0 => x0.style,
      _1690: x0 => x0.sheet,
      _1691: x0 => x0.src,
      _1692: (x0,x1) => { x0.src = x1 },
      _1693: x0 => x0.naturalWidth,
      _1694: x0 => x0.naturalHeight,
      _1701: x0 => x0.offsetX,
      _1702: x0 => x0.offsetY,
      _1703: x0 => x0.button,
      _1710: x0 => x0.status,
      _1711: (x0,x1) => { x0.responseType = x1 },
      _1713: x0 => x0.response,
      _1762: (x0,x1) => { x0.responseType = x1 },
      _1763: x0 => x0.response,
      _1838: x0 => x0.style,
      _2315: (x0,x1) => { x0.src = x1 },
      _2322: (x0,x1) => { x0.allow = x1 },
      _2334: x0 => x0.contentWindow,
      _2767: (x0,x1) => { x0.accept = x1 },
      _2781: x0 => x0.files,
      _2807: (x0,x1) => { x0.multiple = x1 },
      _2825: (x0,x1) => { x0.type = x1 },
      _3523: (x0,x1) => { x0.dropEffect = x1 },
      _3528: x0 => x0.files,
      _3540: x0 => x0.dataTransfer,
      _3544: () => globalThis.window,
      _3586: x0 => x0.location,
      _3587: x0 => x0.history,
      _3603: x0 => x0.parent,
      _3605: x0 => x0.navigator,
      _3860: x0 => x0.isSecureContext,
      _3861: x0 => x0.crossOriginIsolated,
      _3864: x0 => x0.performance,
      _3869: x0 => x0.localStorage,
      _3877: x0 => x0.origin,
      _3886: x0 => x0.pathname,
      _3900: x0 => x0.state,
      _3925: x0 => x0.message,
      _3987: x0 => x0.appVersion,
      _3988: x0 => x0.platform,
      _3991: x0 => x0.userAgent,
      _3992: x0 => x0.vendor,
      _4042: x0 => x0.data,
      _4043: x0 => x0.origin,
      _4415: x0 => x0.readyState,
      _4424: x0 => x0.protocol,
      _4428: (x0,x1) => { x0.binaryType = x1 },
      _4431: x0 => x0.code,
      _4432: x0 => x0.reason,
      _6099: x0 => x0.type,
      _6140: x0 => x0.signal,
      _6198: x0 => x0.parentNode,
      _6212: () => globalThis.document,
      _6294: x0 => x0.body,
      _6337: x0 => x0.activeElement,
      _6971: x0 => x0.offsetX,
      _6972: x0 => x0.offsetY,
      _7057: x0 => x0.key,
      _7058: x0 => x0.code,
      _7059: x0 => x0.location,
      _7060: x0 => x0.ctrlKey,
      _7061: x0 => x0.shiftKey,
      _7062: x0 => x0.altKey,
      _7063: x0 => x0.metaKey,
      _7064: x0 => x0.repeat,
      _7065: x0 => x0.isComposing,
      _7971: x0 => x0.value,
      _7973: x0 => x0.done,
      _8153: x0 => x0.size,
      _8154: x0 => x0.type,
      _8161: x0 => x0.name,
      _8162: x0 => x0.lastModified,
      _8167: x0 => x0.length,
      _8173: x0 => x0.result,
      _8668: x0 => x0.url,
      _8670: x0 => x0.status,
      _8672: x0 => x0.statusText,
      _8673: x0 => x0.headers,
      _8674: x0 => x0.body,
      _10756: (x0,x1) => { x0.backgroundColor = x1 },
      _10802: (x0,x1) => { x0.border = x1 },
      _11080: (x0,x1) => { x0.display = x1 },
      _11244: (x0,x1) => { x0.height = x1 },
      _11934: (x0,x1) => { x0.width = x1 },
      _13021: () => globalThis.console,
